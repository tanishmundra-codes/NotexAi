...
import { BookOpen, Star, FileText, Sparkles, List, Layers, CheckSquare, ArrowUp } from "lucide-react";
    ...
    return (
        <section className="h-screen flex flex-col items-center justify-center px-4 sm:px-6 pt-24 pb-4 md:pt-32 md:pb-8">
            <div className="w-full max-w-4xl mx-auto text-center flex flex-col items-center">
                ...
                <div className="flex flex-col items-center mb-5 md:mb-8 animate-fade-in-up">
                    <img
                ...
                <p className="text-base md:text-base lg:text-lg text-zinc-500 dark:text-zinc-400 max-w-xl mx-auto mb-8 md:mb-10 animate-fade-in-up delay-100 px-2">
                ...
                <div className="w-[90%] sm:w-full max-w-xl mx-auto animate-fade-in-up delay-200">
                    ...
                    <div className="flex flex-wrap justify-center gap-2 md:gap-3 mt-6 md:mt-8 animate-fade-in-up delay-300">
                ...
                {/* --- CTA BUTTONS --- */}
                <div className="flex flex-row items-center justify-center gap-3 mt-8 md:mt-10 animate-fade-in-up delay-300 w-full px-4">
